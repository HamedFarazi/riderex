  ...
  const faqCategories = [
    {
      ...
      faqs: [
        {
          question: 'موتوشاپ چه محصولاتی دارد؟',
          answer: 'موتوشاپ یک پلتفرم آموزش آنلاین است که بیش از ۵۰۰ دوره تخصصی در زمینه‌های مختلف تکنولوژی، کسب‌وکار و هنر ارائه می‌دهد. هدف ما ارائه آموزش با کیفیت و قابل دسترس برای همه افراد است.'
        },
        {
    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: 'بله، در هر دوره بخش سوال و جواب وجود دارد که می‌توانید سوالات خود را مطرح کنید. فروشندگان معتبر معمولا تا ۲۴ ساعت پاسخ می‌دهند.'
        }
      ]
    },
    {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 rtl">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-400">پاسخ سوالات رایج درباره خرید قطعات موتور</p>
      </div>
