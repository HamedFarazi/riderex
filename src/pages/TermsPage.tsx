  ...
  const sections = [
    {
      ...
      title: "شرایط عضویت",
      content: `
        <p>برای استفاده از خدمات رایدرکس، باید حداقل ۱۸ سال سن داشته باشید یا با اجازه والدین یا سرپرست قانونی خود عمل کنید.</p>
    ...
    },
    {
      ...
      content: `
        <p>تمامی محصولات و کالاها ارائه شده در پلتفرم متعلق به رایدرکس است و تحت قوانین کپی‌رایت محافظت می‌شود.</p>
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 rtl">
      ...
      <div className="glass rounded-xl p-8 mb-8">
        ...
        <p className="text-gray-300 leading-relaxed">
          خوش آمدید! این سند شامل قوانین و مقررات استفاده از وب‌سایت و خدمات
          موتوشاپ است. با ثبت‌نام، خرید دوره یا استفاده از هر بخش از سایت، شما
          موافقت خود را با این قوانین اعلام می‌کنید. لطفا این متن را با دقت
          مطالعه کنید.
        </p>
      </div>
      ...
      <div className="glass rounded-xl p-8 mt-8">
        ...
        <div className="space-y-6 text-gray-300">
          <div>
            ...
            <p>
              کاربران باید از رفتار محترمانه در تعامل با سایر کاربران و تیم
              پشتیبانی پیروی کنند و از ارسال محتوای نامناسب، تهدیدآمیز یا
              غیرقانونی خودداری کنند.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              موتوشاپ حق تغییر این قوانین را در هر زمان محفوظ می‌دارد. تغییرات
              مهم از طریق ایمیل یا اعلان در سایت به اطلاع کاربران خواهد رسید.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              این قوانین تحت قوانین جمهوری اسلامی ایران قرار دارد و هرگونه
              اختلاف در محاکم صالح تهران رسیدگی خواهد شد.
            </p>
          </div>
        </div>
      </div>
